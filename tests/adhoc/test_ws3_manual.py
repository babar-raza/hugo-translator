...
def test_priority_1_config_override():
    ...
    with tempfile.TemporaryDirectory() as tmp:
        ...
        print("✓ Test 1 passed: Config override (50) beats hardware baseline (30)")
...
def test_priority_2_cyrillic_conservative_cap():
    ...
    with tempfile.TemporaryDirectory() as tmp:
        ...
        print("✓ Test 2 passed: Cyrillic languages capped at 8 (min(8, 30))")
...
def test_priority_3_hardware_baseline_for_latin():
    ...
    with tempfile.TemporaryDirectory() as tmp:
        ...
        print("✓ Test 3 passed: Latin languages use hardware baseline (30)")
...
def test_priority_4_hardcoded_fallback():
    ...
    with tempfile.TemporaryDirectory() as tmp:
        ...
        print("✓ Test 4 passed: Hardcoded fallback (20 for Latin, 8 for Cyrillic)")
...
def test_cyrillic_uses_lower_hardware():
    ...
    with tempfile.TemporaryDirectory() as tmp:
        ...
        print("✓ Test 6 passed: Cyrillic uses hardware baseline (5) when lower than conservative (8)")
...
def test_config_override_beats_all():
    ...
    with tempfile.TemporaryDirectory() as tmp:
        ...
        result = tracker._get_language_baseline('ru')
        assert result == 50, f"Expected 50, got {result}"
        print("✓ Test 7 passed: Config override (50) beats Cyrillic conservative (8) and hardware (30)")
...
def test_gpu_high_vram_scenario():
    ...
    with tempfile.TemporaryDirectory() as tmp:
        ...
        print("✓ Test 8 passed: High VRAM scenario (Latin=60, Cyrillic=8)")
...
def test_gpu_low_vram_scenario():
    ...
    with tempfile.TemporaryDirectory() as tmp:
        ...
        print("✓ Test 9 passed: Low VRAM scenario (Latin=4, Cyrillic=4)")
...
def test_arabic_conservative_cap():
    ...
    with tempfile.TemporaryDirectory() as tmp:
        ...
        print("✓ Test 10 passed: Arabic languages capped at 10 (min(10, 30))")
