...
class TestProfileEngine(unittest.TestCase):
    ...
    def test_get_profile(self, mock_config_service):
        ...
        mock_service_instance.get_site_profile.assert_called_once_with(
            site_id="products.aspose.com", use_cache=True
        )
    ...
    def test_get_profile_no_cache(self, mock_config_service):
        ...
        mock_service_instance.get_site_profile.assert_called_once_with(
            site_id="docs.aspose.net", use_cache=False
        )
    ...
    def test_resolve_config_validation(self, mock_config_service):
        ...
        engine = ProfileEngine()
        config = engine.resolve_config(site_id="products.aspose.com", config_type="validation")

        self.assertEqual(config["enabled"], True)
        self.assertEqual(config["mode"], "strict")
        mock_service_instance.get_merged_validation_config.assert_called_once_with(mock_profile)
    ...
    def test_resolve_config_terminology(self, mock_config_service):
        ...
        engine = ProfileEngine()
        config = engine.resolve_config(site_id="docs.aspose.net", config_type="terminology")

        self.assertEqual(config["preserve_mode"], "BOTH")
        mock_service_instance.get_merged_terminology_config.assert_called_once_with(mock_profile)
    ...
    def test_resolve_config_metrics(self, mock_config_service):
        ...
        engine = ProfileEngine()
        config = engine.resolve_config(site_id="products.aspose.com", config_type="metrics")
    ...
    def test_resolve_config_global(self, mock_config_service):
        ...
        mock_global_config = {"content_hash_tracking": {"hash_algorithm": "md5"}}
        mock_service_instance.get_config.return_value = mock_global_config
        mock_config_service.return_value = mock_service_instance

        engine = ProfileEngine()
        config = engine.resolve_config(site_id="products.aspose.com", config_type="global")
    ...
    def test_resolve_config_invalid_type(self, mock_config_service):
        ...
        with self.assertRaises(ValueError) as ctx:
            engine.resolve_config(site_id="products.aspose.com", config_type="invalid_type")
    ...
    def test_reload_profile(self, mock_config_service):
        ...
        self.assertEqual(profile, mock_profile)
        mock_service_instance.reload_profile.assert_called_once_with("products.aspose.com")
    ...
    def test_get_validation_config(self, mock_config_service):
        ...
        mock_service_instance.get_validation_config.assert_called_once_with(use_cache=True)
    ...
    def test_get_terminology_config(self, mock_config_service):
        ...
        mock_service_instance.get_terminology_config.assert_called_once_with(use_cache=True)
    ...
    def test_get_metrics_config(self, mock_config_service):
        ...
        mock_service_instance = Mock()
        mock_metrics = {
            "metrics": {"storage": {"translation_engine": {"retry_metrics_maxlen": 1000}}}
        }
    ...
    def test_get_metrics_config_no_cache(self, mock_config_service):
        ...
        mock_service_instance.get_metrics_config.assert_called_once_with(use_cache=False)
