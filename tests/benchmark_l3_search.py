...
def main():
    ...
    print(
        f"Benchmark: L3 semantic search (mock encoder, {_N_ENTRIES} entries, {_N_QUERIES} queries)"
    )
    print("Model: all-MiniLM-L6-v2 (mocked), Device: CPU (mock), Index: IndexFlatL2")
    print("=" * 70)
    ...
    print("   batch path: YES, deduplicated")
