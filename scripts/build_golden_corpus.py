...
def classify_document_complexity(file_path: Path) -> Tuple[str, Dict]:
    ...
    # Classify
    if features['code_block_count'] == 0 and features['shortcode_count'] == 0 and features['file_size'] < 2000:
        tier = 'simple'
    elif features['code_block_count'] > 5 or features['shortcode_count'] > 3 or features['has_tables'] or features['has_math']:
        tier = 'complex'
...
if __name__ == '__main__':
    ...
    parser.add_argument('--output', type=Path, default=Path('data/golden_corpus'), help='Output directory')
    parser.add_argument('--count', type=int, default=50, help='Target document count')
    parser.add_argument('--seed', type=int, default=42, help='Random seed for deterministic sampling')
    parser.add_argument('--verify', action='store_true', help='Verify existing corpus instead of building')
