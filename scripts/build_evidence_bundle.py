...
bundle = {
    ...
    "discovery_fix": {
        ...
        "weight_files_checked": [
            ...
            "pytorch_model-*.bin (sharded)", "model-*.safetensors (sharded)",
        ],
    ...
    "l0_profile_inventory": {
        ...
        "resolvable_locally": sum(1 for r in profile_inventory["profiles"] if r["roots_resolvable"]),
        "blocked": sum(1 for r in profile_inventory["profiles"] if r["blocking_errors"]),
        "resolvable_profile_ids": [r["site_id"] for r in profile_inventory["profiles"] if r["roots_resolvable"]],
