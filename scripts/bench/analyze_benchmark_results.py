...
class BenchmarkAnalyzer:
    ...
    def compare_gpu_vs_cpu(self) -> dict:
        ...
        return {"best_gpu": best_gpu, "best_cpu": best_cpu, "speedup": speedup}
    ...
    def compare_fp16_vs_fp32(self) -> dict:
        ...
        return {"best_fp16": best_fp16, "best_fp32": best_fp32, "speedup": speedup}
...
def main():
    ...
    if args.latest:
        ...
        benchmark_reports = sorted(
            reports_dir.glob("benchmark_*.md"), key=lambda p: p.stat().st_mtime, reverse=True
        )
