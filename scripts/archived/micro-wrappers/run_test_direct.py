# ARCHIVED: 2026-06-11. Has hardcoded personal paths (anaconda3/envs/llm). No canonical replacement.
...
cmd = [r"C:\Users\prora\anaconda3\envs\llm\python.exe", r"tests\live_translation_simple.py"]
