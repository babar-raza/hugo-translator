...
def main():
    ...
    report = check_language_coverage("config/model_registry.yaml", "config/target_languages.yaml")
    ...
    # Analyze gaps
    recommendations = analyze_gaps(report.models_per_language, report.missing_languages)
