...
def copy_model_to_organized_layout(
    lang: str, source_path: Path, models_dir: Path, dry_run: bool = False
) -> bool:
    """
...
def main() -> int:
    ...
    parser.add_argument(
        "--dry-run", action="store_true", help="Print what would be done without copying"
    )
    parser.add_argument(
        "--languages", help="Comma-separated list of languages to organize (default: all)"
    )
