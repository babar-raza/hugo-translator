...
def main():
    ...
    parser.add_argument("--all", action="store_true", help="Download all models from registry")
    parser.add_argument("--model", type=str, help="Download specific model by ID")
    parser.add_argument("--force", action="store_true", help="Force re-download if already exists")
    parser.add_argument("--parallel", type=int, default=1, help="Number of concurrent downloads")
    parser.add_argument("--models-dir", type=str, default="models", help="Models base directory")
