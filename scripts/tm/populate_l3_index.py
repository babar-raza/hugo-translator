...
class L3IndexPopulator:
    ...
    def __init__(
        ...
        self.l3 = L3SemanticTM(index_path=self.l3_path, use_gpu=self.use_gpu)
...
def main():
    ...
    parser.add_argument(
        "--use-gpu", action="store_true", help="Use GPU for embeddings (if available)"
    )
    ...
    parser.add_argument(
        "--rebuild", action="store_true", help="Rebuild index from scratch (deletes existing)"
    )
