...
def _count_en_files(root: Path) -> list[Path]:
    ...
    known_langs = {
        "ar","bg","ca","cs","da","de","el","es","fa","fi","fr","he","hi",
        "hr","hu","id","it","ja","ko","lt","lv","ms","nl","no","pl","pt",
        "ro","ru","sk","sr","sv","th","tr","uk","vi","zh",
    }
    try:
...
def main():
    ...
    cand_p.add_argument("--dry-run", action="store_true", default=True,
