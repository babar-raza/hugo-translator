...
if en_stats and bg_stats:
    print(f"EN: {en_stats['lines']} lines, {en_stats['comments']} comments, {en_stats['literal_blocks']} literal blocks")
    print(f"BG: {bg_stats['lines']} lines, {bg_stats['comments']} comments, {bg_stats['literal_blocks']} literal blocks")
