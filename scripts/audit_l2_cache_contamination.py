...
def main():
    ...
    parser.add_argument(
        '--db', default='data/tm/l2.lmdb',
        help='L2 LMDB path (default: data/tm/l2.lmdb)'
    )
    parser.add_argument(
        '--model', default='data/models/fasttext/lid.176.bin',
        help='FastText language model path'
    )
    parser.add_argument(
        '--lang', default=None,
        help='Audit only this target language (e.g. --lang de)'
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        help='Delete contaminated entries (default: report only)'
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        help='Progress log interval in entries (default: 5000)'
    )
    ...
    # Print summary
    print(f"\n{'='*60}")
    print(f"L2 Cache Contamination Audit Report")
    print(f"{'='*60}")
    ...
    if report.contaminated:
        ...
        for entry in report.contaminated[:10]:
            ...
            print(f"  [{entry.site_id}] {entry.src_lang}->{entry.tgt_lang} "
