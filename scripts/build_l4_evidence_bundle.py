...
golden_output_lines = len(golden_fr.read_text(encoding="utf-8").splitlines()) if golden_fr.exists() else 0
...
bundle = {
    ...
    "fixture_layout_fix": {
        ...
        "verification": {
            ...
            "dry_run_post_fix": {
                "golden-test": {"would_translate": 1, "output_path": "data/evidence/rbtw/l4_output/golden-test/fr/minimal_en.md"},
            },
        },
    },
