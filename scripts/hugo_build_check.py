...
def run_hugo_build(source_dir: str, hugo_path: str, timeout: int = 300) -> tuple[int, int, int, str]:
    """
...
def main():
    ...
    parser.add_argument("--source", help="Hugo site root directory (default: ASPOSE_NET_CONTENT parent)")
    parser.add_argument("--error-threshold", type=int, default=0, help="Max allowed ERROR count (default: 0)")
    parser.add_argument("--warn-threshold", type=int, default=50, help="Max allowed WARN count (default: 50)")
