        ...
        for lang_code in test_langs:
            ...
            wrong_markers = {
                "el": [
                    ...
                    "Arxius",
                    "تخزين",
                ],  # Greek shouldn't have Czech/German/Catalan/Arabic
                "de": [
                    "Zkouska",
                    "ΠΡΟΣΟΧΗ",
                    "Arxius",
                    "تخزين",
                ],  # German shouldn't have Czech/Greek/Catalan/Arabic
                "tr": [
                    "Zkouska",
                    "Ubersetzer",
                    "ΠΡΟΣΟΧΗ",
