...
#   powershell -ExecutionPolicy Bypass -File scripts/admin/apply_worker_scheduler_cleanup.ps1 -Mode dry-run -WorkersToDisable ContentWorker,TMWorker,AutonomousVerification
#
#   # Apply (requires admin / UAC):
#   Start-Process powershell -Verb RunAs -ArgumentList '-ExecutionPolicy Bypass', '-File', 'scripts/admin/apply_worker_scheduler_cleanup.ps1', '-Mode', 'apply', '-WorkersToDisable', 'ContentWorker,TMWorker,AutonomousVerification'
