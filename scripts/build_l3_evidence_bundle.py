...
golden_output_files = list(l3_output.glob("golden-test/**/*")) if (l3_output / "golden-test").exists() else []
ws5_output_files = list(l3_output.glob("ws5-test/**/*")) if (l3_output / "ws5-test").exists() else []
docs_output_files = list(l3_output.glob("docs.aspose.net/**/*")) if (l3_output / "docs.aspose.net").exists() else []
...
bundle = {
    ...
    "readiness_evidence_verification": {
        ...
        "checks": {
            "opus_smoke_pass": {"status": "PASS", "evidence": "disc_tra_helsinki_nlp_opus_mt_en_fr -> Le document a ete sauvegarde avec succes. (11119ms)"},
            "m2m100_smoke_pass": {"status": "PASS", "evidence": "disc_tra_m2m100_418m_hf -> Das Dokument wurde erfolgreich gerettet. (1639ms)"},
            "origin_discovered": {"status": "PASS", "evidence": "origin=discovered for both smoke tests"},
            "local_path_starts_d_models": {"status": "PASS", "evidence": "D:/models/opus_mt_ct2/... for OPUS; D:/models/opus_mt_ct2/m2m100_418m-hf for M2M100"},
            "local_path_exists_true": {"status": "PASS", "evidence": "local_path_exists=True for both"},
            "no_remote_download": {"status": "PASS", "evidence": "model_download_performed=false"},
            "no_production_write": {"status": "PASS", "evidence": "production_content_written=false"},
            "no_model_copy": {"status": "PASS", "evidence": "model_binaries_copied=false"},
            "unit_tests_25_25": {"status": "PASS", "evidence": "tests/models/test_local_discovery.py: 25 passed"},
            "pre_existing_failures_documented": {"status": "PASS", "evidence": "2 failures confirmed pre-existing via git stash; NO_REGRESSIONS_FROM_SPRINT_CHANGES"},
        },
    },
    "preflight": {
        "branch": "main",
    ...
    "candidate_discovery": {
        ...
        "per_profile": {
            ...
            "docs.aspose.net": {"status": "PASS", "en_files": 0, "missing": 0, "note": "en/ subdir exists but empty"},
        },
    },
    "l3_dry_run_commands": [
        {
            ...
            "manifests": ["dry-run-20260507T070527Z.json", "dry-run-20260507T070537Z.json", "dry-run-20260507T070546Z.json", "dry-run-20260507T070556Z.json"],
        ...
        },
        {
            ...
            "would_translate": [{"source_path": "tests\\golden\\fixtures\\minimal_en.md", "target_lang": "fr", "output_path": "data\\evidence\\rbtw\\l3_dry_run_output\\golden-test\\fr"}],
            "no_production_write": True,
        },
        {
            "profile": "ws5-test",
        ...
        },
        {
            ...
            "would_translate": [{"source_path": "tests\\fixtures\\ws5\\content\\file1.md", "target_lang": "es", "output_path": "data\\evidence\\rbtw\\l3_dry_run_output\\ws5-test\\es"}],
            "no_production_write": True,
        },
        {
